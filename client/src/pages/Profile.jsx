...
import { updateUserStart, updateUserSuccess, updateUserFailure, signOutUserStart, signOutUserFailure, signOutUserSuccess } from '../redux/user/userSlice';
import { useDispatch } from 'react-redux';
import { Link } from 'react-router-dom';

// firebase setting rule
// allow read;
//       allow write: if 
...
const Profile = () => {
  ...
  const handleFileUpload = (file) => {
    ...
    uploadTrack.on('state_changed',
      ...
      () => {
        getDownloadURL(uploadTrack.snapshot.ref).then
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <p className="text-red-700 mt-5">{listingsError ? "Error showing Listings" : ""}</p>

      {userListings && userListings.length > 0 &&
        <div className="flex flex-col gap-4">
          <h1 className='font-semibold text-2xl text-center'>Your Listings</h1>
